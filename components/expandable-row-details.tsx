  ...
  return (
    <TableRow className="bg-gray-25 border-b border-gray-200">
      <TableCell colSpan={6} className="py-6 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl ml-2">
          ...
          <div className="space-y-3 md:col-span-2">
            ...
            {isEditing ? (
              ...
              <div className="text-sm pl-1">{supplier.notes || <span className="text-gray-400 italic">No notes</span>}</div>
            )}
          </div>
        </div>
      </TableCell>
